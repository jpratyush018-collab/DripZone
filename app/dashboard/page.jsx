      ...
      <div className="min-h-screen bg-black text-white p-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-400">
            Welcome to your DripZone fashion dashboard.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="border border-gray-700 rounded-lg p-6 text-center">
            ...
            <p className="mt-2 text-gray-400">Products Available</p>
          </div>
        ...
        <div>
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            ...
            <Card
              ...
              link="https://nobero.com/products/grow-through-oversized-hoodie"
            />
            ...
            <Card
              ...
              image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuy_hi3jVW87fkaAa_MZU6jAdX9nYuFp-OhQ&s"
